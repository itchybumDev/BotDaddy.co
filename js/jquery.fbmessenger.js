			...
			<div class="jsm-iphone-content">\
				<div class="jsm-status-navbar">\
					<div class="jsm-status-bar">\
						...
						<div class="jsm-clock" id="jsm-clock">' + this.options.displayedTime + '</div>\
					</div>\
		...
		if (options === undefined || options.delay === undefined) {
			...
			if (options.width) {
				var $content = $('<div class="jsm-chat-message jsm-image-attachment ' +
									...
									' '+
									(options.className || '') +
									'" style="width:' + options.width + '%;"><div class="jsm-image" style="padding-top:'+ options.padding + '%;background-image: url(\'' + imageUrl + '\')"></div>' +
